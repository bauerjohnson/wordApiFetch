...
const Partof = () => {
    ...
    const [meaning1, setmeaning1] = useState([" FINGER is related to what?"]);
...
fetchdata();
  ...
  function fetchword (){
    ...
    Api.getData()
    .then((response) => {
       str1 = response.data.partOf[0];
       str2= response.data.partOf[1];
       str3 = response.data.partOf[2];
       str4 = response.data.partOf[3];
       str5 = response.data.partOf[4];
